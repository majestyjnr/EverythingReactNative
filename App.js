...
export default function App() {
  ...
  const BottomTabScreen = () =>{
    return (
      <Tab.Navigator screenOptions={({route})=>({
        ...
        <Tab.Screen name="Home" component={Home} options={{title: "Instagram", headerRight: (()=>{
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="BottomTabs" options={{headerShown: false}} component={BottomTabScreen}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
}
